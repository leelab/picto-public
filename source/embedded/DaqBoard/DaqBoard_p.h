 ...
 */
/************************************************/
inline void DaqBoard::_ConfigureAI(unsigned int frequency, unsigned int numberOfSamples, bool continuous)
{
	DWORD bytesWritten;
	ULONG data;
 ...
 */
/************************************************/
inline void DaqBoard::_getCalibrationValues(scalingCoeff *_pScale)
{
	ULONG eepromInfo[2];
 ...
 */
/************************************************/
inline float DaqBoard::_aiPolynomialScaler(int _raw, const scalingCoeff *_pScale)
{
	float scaledVal;
	ULONG order;
 ...
 */
/************************************************/
inline void DaqBoard::_readEeprom(unsigned int _offset, UCHAR *_pBuffer, unsigned int _bufferLen)
{
	ULONG iowcr1Initial;
