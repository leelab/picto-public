...
//! Initializes the Reward controllers.
  ...
  */ 
//******************************************************/
bool DaqBoard::initRewardController(int _numControllers, unsigned int _rewardDurations[])
{
	if(hDAQ_ == NULL)
	{
 ...
 */
//******************************************************/
bool DaqBoard::setRewardDuration(int _controller, unsigned int _duration)
{
 ...
 */
//******************************************************/
unsigned int DaqBoard::getRewardDuration(int _controller)
{
	if(_controller > activeRewardControllers_)
		return -1;
 ...
 */
//******************************************************/
bool DaqBoard::giveReward(int _controller)
{
	DWORD buffer;
 ...
 */
//******************************************************/
bool DaqBoard::flushReward(int _controller, bool _flush)
{
	DWORD buffer;
	DWORD bytesWritten,bytesRead;
 ...
 */
//******************************************************/
bool DaqBoard::sendEvent(unsigned char _eventCode)
{
	if(!eventLinesInitialized_)
		return false;
...
bool DaqBoard::CreateAIChannel(int _chanNumber, ChannelType _chanType)
{
	...
	for(unsigned int i=0; i<AIChannelList_.size(); i++)
	{
...
bool DaqBoard::RemoveAIChannel(int _chanNumber)
{
 ...
 */
//******************************************************/
bool DaqBoard::ClearAIChannelList()
{
 ...
 */
//******************************************************/
bool DaqBoard::StartAI(unsigned int _frequency, bool _continuous, unsigned int _numberOfSamples)
{
 ...
 */
//******************************************************/
int DaqBoard::CollectAIData(unsigned int _numSamples)
{
	if(!hDAQ_)
	{
...
DaqBoard::AIChannel* DaqBoard::GetAIChannel(int _chanNumber)
{
