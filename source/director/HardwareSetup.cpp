...
#if defined WIN32 && defined NI_STUFF
#include "iodevices/PictoCompRewardController.h"
...
bool HardwareSetup::setupRewardController(RewardControllerType controllerType)
{
	...
	else if (controllerType == PictoCompReward)
	{
#if defined WIN32 && defined NI_STUFF
		rewardController = QSharedPointer<Picto::RewardController>(new Picto::PictoCompRewardController());
#else
		return false;
#endif
	}
