...
HEADERS += $$(PICTO_TREE)/source/director/iodevices/PictoBoxXPOutputSignalController.h
SOURCES += $$(PICTO_TREE)/source/director/iodevices/PictoBoxXPOutputSignalController.cpp
