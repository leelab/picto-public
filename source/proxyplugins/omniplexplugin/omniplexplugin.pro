...
# Input
SOURCES += $$(PICTO_TREE)/source/proxyplugins/omniplexplugin/omniplexplugin.cpp
HEADERS += $$(PICTO_TREE)/source/proxyplugins/omniplexplugin/omniplexplugin.h


include($$(PICTO_TREE)/source/common/common.pri)

# Resources
RESOURCES += $$(PICTO_TREE)/source/proxyplugins/omniplexplugin/omniplexplugin.qrc

# Output
build_pass:CONFIG(debug, debug|release) {
  DESTDIR = $$(PICTO_TREE)/output/bin/debug/plugins
  OBJECTS_DIR	= $$(PICTO_TREE)/intermediates/obj/omniplexplugins/debug
}
build_pass:CONFIG(release, debug|release) {
  DESTDIR = $$(PICTO_TREE)/output/bin/release/plugins
  OBJECTS_DIR	= $$(PICTO_TREE)/intermediates/obj/omniplexplugins/release
}
RCC_DIR = $$(PICTO_TREE)/intermediates/resources/omniplexplugins
UI_DIR = $$(PICTO_TREE)/intermediates/ui/omniplexplugins
MOC_DIR = $$(PICTO_TREE)/intermediates/moc/omniplexplugins
