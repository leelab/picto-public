...
HEADERS += $$(PICTO_TREE)/source/workstation/statemachineeditor/AssetDiagramItem.h
SOURCES += $$(PICTO_TREE)/source/workstation/statemachineeditor/AssetDiagramItem.cpp
