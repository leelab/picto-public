...
HEADERS += $$(PICTO_TREE)/source/workstation/statemachineeditor/diagramsceneitem.h
SOURCES += $$(PICTO_TREE)/source/workstation/statemachineeditor/diagramsceneitem.cpp
