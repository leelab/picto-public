...
HEADERS += $$(PICTO_TREE)/source/workstation/statemachineeditor/TaskItem.h
SOURCES += $$(PICTO_TREE)/source/workstation/statemachineeditor/TaskItem.cpp
...
HEADERS += $$(PICTO_TREE)/source/workstation/statemachineeditor/StateMachineItem.h
SOURCES += $$(PICTO_TREE)/source/workstation/statemachineeditor/StateMachineItem.cpp
HEADERS += $$(PICTO_TREE)/source/workstation/statemachineeditor/StateItem.h
SOURCES += $$(PICTO_TREE)/source/workstation/statemachineeditor/StateItem.cpp
HEADERS += $$(PICTO_TREE)/source/workstation/statemachineeditor/ScriptElementItem.h
SOURCES += $$(PICTO_TREE)/source/workstation/statemachineeditor/ScriptElementItem.cpp
HEADERS += $$(PICTO_TREE)/source/workstation/statemachineeditor/RewardItem.h
SOURCES += $$(PICTO_TREE)/source/workstation/statemachineeditor/RewardItem.cpp
HEADERS += $$(PICTO_TREE)/source/workstation/statemachineeditor/FlowElementItem.h
SOURCES += $$(PICTO_TREE)/source/workstation/statemachineeditor/FlowElementItem.cpp
