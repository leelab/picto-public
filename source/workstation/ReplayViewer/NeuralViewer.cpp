...
NeuralViewer::NeuralViewer(QSharedPointer<Picto::Engine::PictoEngine> engine,QWidget *parent) :
	QWidget(parent),
	engine_(engine)
{
	setupUi();
...
NeuralViewer::~NeuralViewer()
{
}

void NeuralViewer::initialize()
{
...
void NeuralViewer::deinitialize()
{
	lfpPlotData_.clear();
...
void NeuralViewer::addLFPData(LFPDataUnitPackage &data)
{
...
void NeuralViewer::addSpikeData(NeuralDataUnit &data)
{
	latestNeuralDataId_ = data.getDataID();
...
void NeuralViewer::updatePlotOptions()
{
...
void NeuralViewer::plotChannelChanged(int)
{
...
void NeuralViewer::plotUnitChanged(int)
{
	spikePlotNeedsUpdate_ = true;
	replot();
}