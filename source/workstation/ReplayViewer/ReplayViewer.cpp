 ...
 */
void ReplayViewer::updateEngine()
{
	...
	if(engineTrigger_ == StartEngine)
	{
		...
		Q_ASSERT_X(taskIdx >= 0,"ReplayViewer::joinSession", "Task name not found in out list of experiments.");
...
void ReplayViewer::setupUi()
{
	...
	//----------Plots---------------
	neuralDataViewer_ = new NeuralViewer(engine_);

	//--------Run Info--------------
	currentRunViewer_ = new BehavViewer();
...
void ReplayViewer::setupServerChannel()
{
...
void ReplayViewer::modifyRunDataUnit(qulonglong runId)
{
...
void ReplayViewer::LoadPropValsFromFile()
{
...
void ReplayViewer::parameterMessageReady(QSharedPointer<Property> changedProp)
{
...
void ReplayViewer::operatorClickDetected(QPoint pos)
{
...
void ReplayViewer::zoomChanged(int zoom)
{
...
void ReplayViewer::setStatus(QString status, bool highPriority)
{
	if(!statusBar_)
		return;
	if(highPriority)
 ...
 */
void ReplayViewer::updateStatus()
{
...
void ReplayViewer::generateTaskList()
{
 ...
 */
void ReplayViewer::updateComponentLists(bool immediate)
{
	if(!immediate)
	{
	...
	{
		foreach(ReplayViewer::ComponentInstance director,directors)
		{
...
void ReplayViewer::updateNeuralData()
{
 ...
 */
ReplayViewer::ComponentStatus ReplayViewer::directorStatus(QString id)
{
 ...
 */
ReplayViewer::ComponentStatus ReplayViewer::proxyStatus(QString id)
{
 ...
 *	list is returned.
 */  
QList<ReplayViewer::ComponentInstance> ReplayViewer::getDirectorList()
{
 ...
 *	list is returned.
 */  
QList<ReplayViewer::ComponentInstance> ReplayViewer::getProxyList()
{
...
void ReplayViewer::updateSessionDataPackage(bool immediate)
{
	if(!immediate)
	{
		//Don't run this too often
 ...
 *		disjoinSession()
 */
bool ReplayViewer::startSession()
{
 ...
 *
 */
bool ReplayViewer::syncExperiment()
{
 ...
 *
 */
void ReplayViewer::stopExperiment()
{
	Q_ASSERT(engine_);
	engine_->stop();
 ...
 */
bool ReplayViewer::disjoinSession()
{
 ...
 */
bool ReplayViewer::shouldEndSession()
{
	if(!isAuthorized_)
		return false;
 ...
 */
QSharedPointer<Picto::ProtocolResponse> ReplayViewer::sendCommandGetReply(QSharedPointer<Picto::ProtocolCommand> cmd, int nonDefaultTimeoutMs)
{
	QTime timer;
	timer.start();
...
bool ReplayViewer::sendTaskCommand(QString target, QString msgContent)
{
 ...
 */
void ReplayViewer::taskListIndexChanged(int)
{
 ...
 */
bool ReplayViewer::assureChannelConnections()
{
