#include <QLabel>
#include <QMessageBox>
#include "BehavViewer.h"
#include "../common/globals.h"
#include "../../common/memleakdetect.h"
using namespace Picto;


BehavViewer::BehavViewer(QWidget *parent) :
	QWidget(parent)
{
...
BehavViewer::~BehavViewer()
{
}

void BehavViewer::setTaskRunData(QMap<qulonglong,QSharedPointer<Picto::TaskRunDataUnit>> dataMap)
{
...
void BehavViewer::markLatestAsRunning(bool isRunning)
{
...
QIcon BehavViewer::getLatestRunIcon()
{
...
void BehavViewer::enableEditing(bool enable)
{
...
QSharedPointer<TaskRunDataUnit> BehavViewer::getSelectedRun()
{
...
QSharedPointer<Picto::TaskRunDataUnit> BehavViewer::getLatestRun()
{
...
bool BehavViewer::selectedRunIsActive()
{
...
void BehavViewer::updateComboBox()
{
	if(editing_)
		return;
...
void BehavViewer::updateFieldsFromCurrentRun()
{
	if(editing_)
		return;
...
void BehavViewer::updateCurrentRunFromFields()
{
	if(!editingEnabled_)
		return;
...
void BehavViewer::updateSaveButtonIcon()
{
...
void BehavViewer::setStateToEditing()
{
	if(!editingEnabled_)
		return;
...
void BehavViewer::setStateToReadOnly()
{
...
void BehavViewer::cancelTriggered()
{
	setStateToReadOnly();
}

void BehavViewer::availableRunsIndexChanged(int)
{
	updateFieldsFromCurrentRun();
}

void BehavViewer::saveToggled(bool)
{
	updateSaveButtonIcon();
}