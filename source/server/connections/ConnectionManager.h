...
public:
	...
	QSharedPointer<SessionInfo> createSession(QUuid directorID, QUuid proxyID, QString experimentName, QByteArray experimentXml, QByteArray experimentConfig, QUuid initialObserverId, QString password);
