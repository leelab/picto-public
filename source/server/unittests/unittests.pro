...
HEADERS += $$(PICTO_TREE)/source/server/unittests/PictoDirectorTest.h
SOURCES += $$(PICTO_TREE)/source/server/unittests/PictoDirectorTest.cpp
...
build_pass:CONFIG(debug, debug|release) {
  ...
  OBJECTS_DIR	= $$(PICTO_TREE)/intermediates/obj/server/tests/debug
}
build_pass:CONFIG(release, debug|release) {
  DESTDIR = $$(PICTO_TREE)/output/tests/bin/release
  OBJECTS_DIR	= $$(PICTO_TREE)/intermediates/obj/server/tests/release
}
RCC_DIR = $$(PICTO_TREE)/intermediates/resources/server/tests
UI_DIR = $$(PICTO_TREE)/intermediates/ui/server/tests
MOC_DIR = $$(PICTO_TREE)/intermediates/moc/server/tests
