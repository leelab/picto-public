...
///////////////////////////MATLAB CODER////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
QVariantList AnalysisMatlabObj::binocdf(QVariantList in1, QVariantList in2, QVariantList in3)
{
	// Create input data	
...
QVariantList AnalysisMatlabObj::binopdf(QVariantList in1, QVariantList in2, QVariantList in3)
{
	// Create input data	
	vector<double> in1data;
	for (int i = 0; i < in1.size(); i++)
...
QVariantList AnalysisMatlabObj::rand(double in)
{
	// Create output array
	emxArray_real_T* outArr;
	int outSize = in*in;
...
QVariantList AnalysisMatlabObj::normrnd(QVariantList mu, QVariantList sigma)
{
	// Create input data		
	vector<double> in1data;
