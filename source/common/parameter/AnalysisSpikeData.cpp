...
/*! \brief Sets the time of the latest frame to zero.  Spike times will be returned with respect to this latest frame.
 */
...
double AnalysisSpikeData::getZeroTime() const
{
	return zeroTime_;
}
...
/*! \brief Returns a list of spike times that occured with times > the input # sec before the latest frame and <= the
 *	latest frame time.
 */
...
/*! \brief Returns a list of the channels of spikes that occured with times > the input # sec before the latest frame
...
/*! \brief Returns a list of the units of spikes that occured with times > the input # sec before the latest frame
 *	and <= the latest frame time.
 */
...
/*! \brief Returns a list of the waveforms of spikes that occured with times > the input # sec before the latest frame
 *	and <= the latest frame time.
 *	\details This is a list of lists, such that the ith spike's waveform will be at the ith index of the returned list,
 *	and that value will itself be a list.
 */
...
/*! \brief Returns a list of spike times that will occur with times <= the input # sec after the latest frame and > the
 *	latest frame time.
 *	\note In a live test, this will not return a valid value.
 */
...
/*! \brief Returns a list of channels for spikes that will occur with times <= the input # sec after the latest frame
 *	and > the latest frame time.
 *	\note In a live test, this will not return a valid value.
 */
...
/*! \brief Returns a list of units for spikes that will occur with times <= the input # sec after the latest frame
 *	and > the latest frame time.
 *	\note In a live test, this will not return a valid value.
 */
...
/*! \brief Returns a list of waveforms for spikes that will occur with times <= the input # sec after the latest frame
 *	and > the latest frame time.
 *	\details This is a list of lists, such that the ith spike's waveform will be at the ith index of the returned list,
 *	and that value will itself be a list. 
 *	\note In a live test, this will not return a valid value.
...
/*! \brief Functions like getPrevChannels() except that the input time is an absolute time with respect to this element's
 *	zero time instead of an offset
 */
...
/*! \brief Functions like getNextChannels() except that the input time is an absolute time with respect to this element's
 *	zero time instead of an offset
 */
...
/*! \brief Functions like getPrevUnits() except that the input time is an absolute time with respect to this element's
 *	zero time instead of an offset
 */
...
/*! \brief Functions like getNextUnits() except that the input time is an absolute time with respect to this element's
 *	zero time instead of an offset
 */
...
/*! \brief Functions like getPrevWaveforms() except that the input time is an absolute time with respect to this element's
 *	zero time instead of an offset
 */
...
/*! \brief Functions like getNextWaveforms() except that the input time is an absolute time with respect to this element's
 *	zero time instead of an offset
 */
