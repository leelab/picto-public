...
curr->setOverview("This element is used to create a circular graphic on screen.  The center of the graphic will lie at the set 'Position'.");
	...
	curr->addSFunc("getLatestValue(int channel)","Returns the latest value of the input lfp channel.");
	...
	curr->addSFunc("getNextValue(int channel)","Returns the next value of the input lfp channel.  Note that this only returns valid data when replaying an experiment.  Picto cannot predict the future.");
	...
	curr->addSFunc("getPrevTimes(double secsPreceding)","Returns a list of times at which lfp values were read and that occured with times > the input # sec before the latest frame and &lt;= the latest frame time.  Indeces in the returned list correspond one to one with indices in the lists returned from the getPrevValues() functions.");
	curr->addSFunc("getNextTimes(double secsFollowing)","Returns a list of times at which lfp values will be read and with times > the latest frame time and &lt;= the input # sec after the latest frame.  Indeces in the returned list correspond one to one with indices in the list returned from the getNextValues() functions.");
	curr->addSFunc("getPrevValues(int channel,double secsPreceding)","Returns a list of lfp values for the input lfp channel that occured with times > the input # sec before the latest frame and &lt;= the latest frame time.  Indeces in the returned list correspond one to one with indices in the list returned from getPrevTimes().");
	curr->addSFunc("getNextValues(int channel,double secsFollowing)","Returns a list of lfp values for the input lfp channel that will occur with times > the latest frame time and &lt;= the input # sec after the latest frame.  Indeces in the returned list correspond one to one with indices in the list returned from getNextTimes().");
	curr->addSFunc("getPrevValues(double secsPreceding)","Returns a list of lfp values for all lfp channels that will occur with times > the input # sec before the latest frame time and &lt;= the latest frame time. Returned value is a list of lists such that each index of the list contains a list of lfp channel values ordered like the result of getChannels().  Indeces in the returned list correspond one to one with indices in the list returned from getPrevTimes().");
	curr->addSFunc("getNextValues(double secsFollowing)","Returns a list of lfp values for all lfp channels that will occur with times > the latest frame time and &lt;= the input # sec after the latest frame. Returned value is a list of lists such that each index of the list contains a list of lfp channel values ordered like the result of getChannels().  Indeces in the returned list correspond one to one with indices in the list returned from getNextTimes().");
	...
	curr->addSFunc("getPrevTimes(secsPreceding)","Returns a javascript array of reward supply times that occured after the input number of seconds preceding the latest frame time, up to and including the latest frame time.  Note that the input quantity need not be an integer.");
	curr->addSFunc("getNextTimes(secsFollowing)","Returns a javascript array of reward supply times that will occur starting from the next frame time, up to and including the time at the input number of seconds following the latest frame time.  Note that the input quantity need not be an integer.  Also note that this function will only return data when replaying an experiment.  Picto cannot predict the future.");
	...
	curr->addSFunc("getPrevTimes(double secsPreceding)","Returns a list of signal reading times that occured with times > the input # sec before the latest frame and &lt;= the latest frame time.  Indeces in the returned list correspond one to one with indices in the lists returned from the getPrevValues() functions.");
	curr->addSFunc("getNextTimes(double secsFollowing)","Returns a list of signal reading times that occured with times > the latest frame time and &lt;= the input # sec after the latest frame.  Indeces in the returned list correspond one to one with indices in the list returned from the getNextValues() functions.");
	curr->addSFunc("getPrevValues(QString componentName,double secsPreceding)","Returns a list of signal values for the input componentName that occured with times > the input # sec before the latest frame and &lt;= the latest frame time.  Indeces in the returned list correspond one to one with indices in the list returned from getPrevTimes().");
	curr->addSFunc("getNextValues(QString componentName,double secsFollowing)","Returns a list of signal values for the input sub channel that will occur with times > the latest frame time and &lt;= the input # sec after the latest frame.  Indeces in the returned list correspond one to one with indices in the list returned from getNextTimes().");
	curr->addSFunc("getPrevValues(double secsPreceding)","Returns a list of signal values for all subcomponents that will occur with times > the input # sec before the latest frame time and &lt;= the latest frame time. Returned value is a list of lists such that each index of the list contains a list of signal subcomponents values ordered like the result of getComponentNames().  Indeces in the returned list correspond one to one with indices in the list returned from getPrevTimes().");
	curr->addSFunc("getNextValues(double secsFollowing)","Returns a list of signal values for all subcomponents that will occur with times > the latest frame time and &lt;= the input # sec after the latest frame. Returned value is a list of lists such that each index of the list contains a list of signal subcomponent values ordered like the result of getComponentNames().  Indeces in the returned list correspond one to one with indices in the list returned from getNextTimes().");
	...
	curr->addSFunc("getPrevTimes(secsPreceding)","Returns an array of spike times that occured after the input number of seconds preceding the latest frame time, up to and including the latest frame time.  There is a one to one matchup between the arrays for all of the getPrevValues() functions (ie. The same index in the array in different returned arrays provides data about the same spike).   Note that the input quantity need not be an integer.");
	curr->addSFunc("getPrevChannels(secsPreceding)","Returns an array of channels on which spikes occured after the input number of seconds preceding the latest frame time, up to and including the latest frame time.  There is a one to one matchup between the arrays for all of the getPrevValues() functions (ie. The same index in the array in different returned arrays provides data about the same spike).  Note that the input quantity need not be an integer.");
	curr->addSFunc("getPrevUnits(secsPreceding)","Returns an array of the units (within a channel) on which spikes occured after the input number of seconds preceding the latest frame time, up to and including the latest frame time.  There is a one to one matchup between the arrays for all of the getPrevValues() functions (ie. The same index in the array in different returned arrays provides data about the same spike).  Note that the input quantity need not be an integer.");
	curr->addSFunc("getPrevWaveforms(secsPreceding)","Returns an array of waveforms of spikes that occured after the input number of seconds preceding the latest frame time, up to and including the latest frame time.  Note that the returned quantity is an array of waveform data arrays, ie. To access the mth element of the nth waveform, use getPrevWaveforms(?)[n][m].  There is a one to one matchup between the arrays for all of the getPrevValues() functions (ie. The same index in the array in different returned arrays provides data about the same spike).  Note that the input quantity need not be an integer.");
	curr->addSFunc("getNextTimes(secsPreceding)","Returns an array of spike times that will occur with times > the latest frame time and &lt;= the input # sec after the latest frame.  There is a one to one matchup between the arrays for all of the getNextValues() functions (ie. The same index in the array in different returned arrays provides data about the same spike).   Note that the input quantity need not be an integer.");
	curr->addSFunc("getNextChannels(secsPreceding)","Returns an array of channels of spikes that will occur with times > the latest frame time and &lt;= the input # sec after the latest frame.  There is a one to one matchup between the arrays for all of the getNextValues() functions (ie. The same index in the array in different returned arrays provides data about the same spike).  Note that the input quantity need not be an integer.");
	curr->addSFunc("getNextUnits(secsPreceding)","Returns an array of units (within a channel) that will occur with times > the latest frame time and &lt;= the input # sec after the latest frame.  There is a one to one matchup between the arrays for all of the getNextValues() functions (ie. The same index in the array in different returned arrays provides data about the same spike).  Note that the input quantity need not be an integer.");
	curr->addSFunc("getNextWaveforms(secsPreceding)","Returns an array of waveforms of spikes that will occur with times > the latest frame time and &lt;= the input # sec after the latest frame.  Note that the returned quantity is an array of waveform data arrays, ie. To access the mth element of the nth waveform, use getNextWaveforms(?)[n][m].  There is a one to one matchup between the arrays for all of the getNextValues() functions (ie. The same index in the array in different returned arrays provides data about the same spike).  Note that the input quantity need not be an integer.");
