 ...
 *	The widget is a simple button that when pressed opens a file dialog.  Before a file has been selected, the button label is "Select File", 
 *	after a file has been selected, the name of the file is used for the label.  The Property that this widget interacts with stores the 
