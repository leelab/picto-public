...
*	\note The main implementation of this function is now in ViewerWindow. The only thing this function does now
*	is set the variable useNavigateMode_ to true.
*/
...
*	to drag the canvas position.  In EditorState::Select mode, clicking on a DiagramItem causes it to be selected.
*	\note The main implementation of this function is now in ViewerWindow. The only thing this function does now
*	is set the variable useNavigateMode_ to false.
*/
