...
HEADERS += $$(PICTO_TREE)/source/common/storage/BehavioralUnitDataStore.h
SOURCES += $$(PICTO_TREE)/source/common/storage/BehavioralUnitDataStore.cpp
HEADERS += $$(PICTO_TREE)/source/common/storage/FrameDataStore.h
SOURCES += $$(PICTO_TREE)/source/common/storage/FrameDataStore.cpp
HEADERS += $$(PICTO_TREE)/source/common/storage/FrameUnitDataStore.h
SOURCES += $$(PICTO_TREE)/source/common/storage/FrameUnitDataStore.cpp
HEADERS += $$(PICTO_TREE)/source/common/storage/RewardDataStore.h
SOURCES += $$(PICTO_TREE)/source/common/storage/RewardDataStore.cpp
HEADERS += $$(PICTO_TREE)/source/common/storage/StateDataStore.h
SOURCES += $$(PICTO_TREE)/source/common/storage/StateDataStore.cpp
...
HEADERS += $$(PICTO_TREE)/source/common/storage/AlignmentDataStore.h
SOURCES += $$(PICTO_TREE)/source/common/storage/AlignmentDataStore.cpp
...
HEADERS += $$(PICTO_TREE)/source/common/storage/LFPDataStore.h
SOURCES += $$(PICTO_TREE)/source/common/storage/LFPDataStore.cpp
