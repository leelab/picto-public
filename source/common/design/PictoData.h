 ...
 *	\details This DataStore is the root DataStore of the entire Picto Design.  Its children include Experiment objects,
 *	and any number of Analysis objects and UIData objects.  Whereas the DesignRoot is a convenient package for moving
 *	designs around, the PictoData node is the real root of the design, included in the actual
