...
SamplingBarPlotPlotHandler::SamplingBarPlotPlotHandler()
	: m_pAxisHandler(nullptr)
{

}

void SamplingBarPlotPlotHandler::handleXLabels(long lLowerBound, long lUpperBound)
{
	if (m_pAxisHandler)
	{
...
void SamplingBarPlotPlotHandler::initializeSamplingBarPlot(BarAxisHandler *pHandler)
{
