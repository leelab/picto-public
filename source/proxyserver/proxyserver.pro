...
HEADERS += $$(PICTO_TREE)/source/proxyserver/dialog.h
SOURCES += $$(PICTO_TREE)/source/proxyserver/dialog.cpp
...
HEADERS += $$(PICTO_TREE)/source/proxyserver/service/systemservice.h
SOURCES += $$(PICTO_TREE)/source/proxyserver/service/systemservice.cpp
