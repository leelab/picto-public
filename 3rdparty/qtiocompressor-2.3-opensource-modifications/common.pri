...
#must rename it here.
wince*:QTIOCOMPRESSOR_LIBNAME = $$qtLibraryTarget(IOCompressor-2.3)
CONFIG(debug, debug|release) {
win32:!wince*:QTIOCOMPRESSOR_LIBNAME = QtSolutions_IOCompressor-2.3d
win32:wince*:QTIOCOMPRESSOR_LIBNAME = IOCompressor-2.3d
QTIOCOMPRESSOR_LIBDIR = $$PWD/lib/debug
}
CONFIG(release, debug|release) {
QTIOCOMPRESSOR_LIBDIR = $$PWD/lib/release
}
TEMPLATE -= fakelib
unix:!macx {
...
macx {
QMAKE_LFLAGS_SONAME = -install_name$${LITERAL_WHITESPACE}@executable_path/../Libraries/qtiocompressor/
