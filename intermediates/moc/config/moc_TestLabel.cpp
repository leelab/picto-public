...
#include "../../../source/config/TestLabel.h"
...
const QMetaObject TestLabel::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_TestLabel.data,
      qt_meta_data_TestLabel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *TestLabel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TestLabel.stringdata0))
        return static_cast<void*>(const_cast< TestLabel*>(this));
