/****************************************************************************
** Meta object code from reading C++ file 'ScriptTextEdit.h'
**
...
#include "../../../source/common/designer/ScriptTextEdit.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'ScriptTextEdit.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ScriptTextEdit_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ScriptTextEdit_t qt_meta_stringdata_ScriptTextEdit = {
    {
QT_MOC_LITERAL(0, 0, 14), // "ScriptTextEdit"
...
QT_MOC_LITERAL(5, 77, 20) // "updateLineNumberArea"
    ...
    "ScriptTextEdit\0updateLineNumberAreaWidth\0"
...
const QMetaObject ScriptTextEdit::staticMetaObject = {
    { &SearchablePlainTextEdit::staticMetaObject, qt_meta_stringdata_ScriptTextEdit.data,
      qt_meta_data_ScriptTextEdit,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ScriptTextEdit::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ScriptTextEdit.stringdata0))
        return static_cast<void*>(const_cast< ScriptTextEdit*>(this));
    return SearchablePlainTextEdit::qt_metacast(_clname);
}

int ScriptTextEdit::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = SearchablePlainTextEdit::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 3)
