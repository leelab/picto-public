...
#include "../../../source/common/designer/Copier.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Copier_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Copier_t qt_meta_stringdata_Copier = {
    {
QT_MOC_LITERAL(0, 0, 6) // "Copier"
...
const QMetaObject Copier::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Copier.data,
      qt_meta_data_Copier,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
