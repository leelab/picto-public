...
#include "../../../source/common/designer/PropertyBrowser.h"
...
struct qt_meta_stringdata_PropertyBrowser_t {
    QByteArrayData data[11];
    char stringdata0[138];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PropertyBrowser_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_PropertyBrowser_t qt_meta_stringdata_PropertyBrowser = {
    {
QT_MOC_LITERAL(0, 0, 15), // "PropertyBrowser"
QT_MOC_LITERAL(1, 16, 13), // "assetSelected"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 21), // "QSharedPointer<Asset>"
QT_MOC_LITERAL(4, 53, 5), // "asset"
QT_MOC_LITERAL(5, 59, 14), // "propertyEdited"
QT_MOC_LITERAL(6, 74, 24), // "QSharedPointer<Property>"
QT_MOC_LITERAL(7, 99, 4), // "prop"
QT_MOC_LITERAL(8, 104, 3), // "val"
QT_MOC_LITERAL(9, 108, 17), // "arrowPortSelected"
QT_MOC_LITERAL(10, 126, 11) // "clearAssets"

    },
    "PropertyBrowser\0assetSelected\0\0"
    "QSharedPointer<Asset>\0asset\0propertyEdited\0"
    "QSharedPointer<Property>\0prop\0val\0"
    "arrowPortSelected\0clearAssets"
};
...
void PropertyBrowser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        PropertyBrowser *_t = static_cast<PropertyBrowser *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        case 2: _t->arrowPortSelected((*reinterpret_cast< QSharedPointer<Asset>(*)>(_a[1]))); break;
...
const QMetaObject PropertyBrowser::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_PropertyBrowser.data,
      qt_meta_data_PropertyBrowser,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *PropertyBrowser::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PropertyBrowser.stringdata0))
