...
#include "../../../source/common/designer/FileSelectWidget.h"
...
QT_MOC_LITERAL(3, 34, 10) // "selectFile"
    ...
    "FileSelectWidget\0editingFinished\0\0"
    "selectFile"
};
...
void FileSelectWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FileSelectWidget::editingFinished)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject FileSelectWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_FileSelectWidget.data,
      qt_meta_data_FileSelectWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *FileSelectWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FileSelectWidget.stringdata0))
        return static_cast<void*>(const_cast< FileSelectWidget*>(this));
...
// SIGNAL 0
void FileSelectWidget::editingFinished()
{
