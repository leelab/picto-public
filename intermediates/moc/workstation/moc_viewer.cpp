...
#include "../../../source/workstation/viewer.h"
...
QT_MOC_LITERAL(1, 7, 14), // "deinitComplete"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 4), // "init"
QT_MOC_LITERAL(4, 28, 6), // "deinit"
QT_MOC_LITERAL(5, 35, 11) // "aboutToSave"

    },
    "Viewer\0deinitComplete\0\0init\0deinit\0"
    "aboutToSave"
};
...
void Viewer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->deinitComplete(); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Viewer::deinitComplete)) {
                *result = 0;
            }
        }
    }
